...
#==================================================================================================================================#
#-----------------------------------  Scenario 2: Interaction Normal ---------------------------------------------------------------#
#==================================================================================================================================#

gen_x1 = function(dat, m = dat$muD, s = 4) {
...
setup = sim_base(data = base_id(nDomains = Domains, nUnits = pop_size)) %>%
  ...
  sim_resp_eq(y =  15000 - 500 * x1 * x2 - 250 * (x2 ^ 2) + v + e)
...
save.image("mod2/model_objects.RData")
save(input_elements,
     setup,
     aux.list,
     Domains,
     ...
     sample_size,
     time.sim,
     file = "mod2/model_specf_objects.RData")
...
write.csv(alt.matrix, "mod2/results/pop.value.csv", row.names = F)
